...
def linear_newmark_krenk(M,C,K,f,u0,udot0,h,gamma=0.5,beta=0.25):
    ...
    if do_err==True:
        ...
        print('Initial displacment dimension is ' + str(u0.shape[1]))     
        print('Initial velocity dimension is ' + str(udot0.shape[1]))     
